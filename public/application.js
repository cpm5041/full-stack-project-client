...
/***/ (function(module, exports, __webpack_require__) {
	...
	var workoutEvents = __webpack_require__(12);
	var workoutLogic = __webpack_require__(36);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://cpmfullstackproject.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showContentBody = function showContentBody(event) {
	  $('#contentBody').show();
	};
	var showWorkoutDiv = function showWorkoutDiv(event) {
	  console.log('track');
	...
	var addShups = function addShups(event) {
	  event.preventDefault();
	...
	module.exports = {
	  ...
	  showContentBody: showContentBody
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetWorkouts = function onGetWorkouts(event) {
	  // event.preventDefault()
	  api.getWorkouts().then(ui.getWorkoutsSuccess).catch(ui.failure);
	};

	var onClearWorkouts = function onClearWorkouts(event) {
	  event.preventDefault();
	  ui.clearWorkouts();
	};
	var onCreateWorkouts = function onCreateWorkouts(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.createWorkouts(data).then(ui.createWorkoutsSuccess).catch(ui.failure).done(onGetWorkouts);
	};
	var onDeleteSingleWorkout = function onDeleteSingleWorkout(event) {
	  event.preventDefault();
	  var id = $(this).attr('data-id');
	  $(this).closest('li').hide();
	  api.deleteWorkout(id).then(ui.deleteWorkoutsSuccess).catch(ui.failure);
	};
	var onToggleUpdate = function onToggleUpdate(event) {
	  event.preventDefault();
	  var id = $(this).attr('data-id');
	  $('#updateForm' + id).slideToggle();
	};
	var onSubmitUpdate = function onSubmitUpdate(event) {
	  event.preventDefault();
	  var id = $(this).attr('id');
	  var data = getFormFields(this);
	  ...
	  // $(this + id).html(data)
	  api.updateWorkout(id, data).then(ui.updateWorkoutsSuccess).catch(ui.failure).done(onGetWorkouts);
	};
	var onHelpVideos = function onHelpVideos(event) {
	  event.preventDefault();
	  $('#videos').slideToggle();
	};
	var onMotivation = function onMotivation(event) {
	  event.preventDefault();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createWorkouts = function createWorkouts(data) {
	  return $.ajax({
	    // config.apiOrigins
	    url: config.apiOrigin + '/workouts', // "http://book-json.herokuconfig.com/books"
	    method: 'POST',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showWorkoutsTemplate = __webpack_require__(15);
	var updateWorkoutsTemplate = __webpack_require__(35);

	var getWorkoutsSuccess = function getWorkoutsSuccess(data) {
	  var showWorkoutsHtml = showWorkoutsTemplate({
	  ...
	  $('#divCheckbox').css('display', 'none');
	  $('#divCheckboxFailure').css('display', 'none');
	  var array = data.workouts;
	  addWorkouts(array);
	};
	var addWorkouts = function addWorkouts(data) {
	  var shupTotal = 0;
	  var squatTotal = 0;
	  var burpeeTotal = 0;
	  var shupMax = 0;
	...
	var clearWorkouts = function clearWorkouts() {
	  $('.showWorkoutForm').css('display', 'none');
	  $('#bicep').css('display', 'none');
	  $('#workoutStats').css('display', 'none');
	};
	var createWorkoutsSuccess = function createWorkoutsSuccess(data) {
	  $('#workoutForm').trigger('reset');
	  $('#bicep').css('display', 'block');
	  $('#workoutButtons').css('display', 'block');
	};
	var deleteWorkoutsSuccess = function deleteWorkoutsSuccess(data) {
	  console.log('clearing single workout');
	};
	var updateWorkoutsSuccess = function updateWorkoutsSuccess(data) {
	  console.log('updating single workout success', data);
	  var updateWorkoutsHtml = updateWorkoutsTemplate({
	...
	module.exports = {
	  ...
	  createWorkoutsSuccess: createWorkoutsSuccess,
	  failure: failure,
	  deleteWorkoutsSuccess: deleteWorkoutsSuccess,
	  updateWorkoutsSuccess: updateWorkoutsSuccess,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <li data-id: \""
	    ...
	    + "\" class='this"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + " col-md-4 updatedWk list-unstyled text-center'>\n      <h1>  <small>Workout stats: "
	    ...
	    + "\" class=\"workouts workoutStats list-unstyled\">\n          <!-- Default Workout input form -->\n          <div>\n            <p>Push-ups: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.shups : stack1), depth0))
	    + "</p>\n            <p>Squats: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.squats : stack1), depth0))
	    + "</p>\n            <p>Burpees: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.burpees : stack1), depth0))
	    + "</p>\n            <p><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class='btn btn-danger text-center apiButton deleteButton' type=\"button\" name=\"delete_button\">F that workout!</button></p>\n            <p><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class='btn btn-warning text-center apiButton updateButton' type=\"button\" name=\"update_button\">Update Reps!</button></p>\n          </div>\n          <div class=\"alert alert-success\" role=\"alert\" id=\"updateSuccess"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" style=\"display: none;\">Success!</div>\n          <!-- Update Workout input form -->\n          <div data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" id=\"updateForm"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"class='form-group updateDiv text-center'style='display: none'>\n            <form id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class='text-center form-group updateForm'>\n              <p><input id='updateShupsInput' type=\"number\" min=\"0\" name=\"workout[shups]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.shups : stack1), depth0))
	    + "\" placeholder=\"# of 'shups\" required></p>\n              <p><input id='updateSquatsInput' type=\"number\" min=\"0\" name=\"workout[squats]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.squats : stack1), depth0))
	    + "\" placeholder=\"# of squats\" required></p>\n              <p><input id='updateBurpeesInput' type=\"number\" min=\"0\" name=\"workout[burpees]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.burpees : stack1), depth0))
	    + "\" placeholder=\"# of burpees\" required></p>\n              <br>\n              <p><input id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type='submit' class=\"btn btn-primary text-center saveUpdate\" value='Update workout!'></p>\n            </form>\n              <br>\n          </div>\n        </ul>\n      </div>\n      <hr>\n    </li>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<ul>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.workouts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n</ul>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<!-- Default Workout input form -->\n<div>\n  <p>Push-ups: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.workout : depth0)) != null ? stack1.shups : stack1), depth0))
	    + "</p>\n  <p>Squats: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.workout : depth0)) != null ? stack1.squats : stack1), depth0))
	    + "</p>\n  <p>Burpees: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.workout : depth0)) != null ? stack1.burpees : stack1), depth0))
	    + "</p>\n  <p><button data-id=\""
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// let totalPushups = 0
	// $('#shupsInput').on('click', function () {
	//   totalPushups += ('$this').value
	// })
